...
# ── LOAD DATA ──────────────────────────────────────────────────────
with st.spinner("Loading and processing data... (this takes ~2 mins on first load)"):
    df = load_data()
...
st.caption("Why I added this: the scatter plot shows individual products. "
           "This chart gives executives a clean category-level summary they "
           "can act on immediately — showing exactly which categories are "
           "oversaturated with sugar and which are protein deserts.")
